...
async function saveFiles(sequencesByFilename) {
  return Object.keys(sequencesByFilename).map(async filename =>
    await saveFile(sequencesByFilename[filename], filename))
}

module.exports = { parseFiles, parseAll, saveFile, saveFiles };
